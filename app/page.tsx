...
const NeeNatuurlijk = () => {
  ...
  <div className={`container px-3 min-h-screen mx-auto flex flex-wrap flex-col md:flex-row items-center`}>
    <div className="flex flex-col bg-slate-50  rounded-lg  w-full md:w-2/5 justify-center items-start text-center md:text-left p-5">
      <p className="uppercase tracking-loose w-full">Is er nog iemand op kantoor?</p>
